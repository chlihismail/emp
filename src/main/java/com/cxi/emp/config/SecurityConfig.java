    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            .authorizeHttpRequests(authorize -> authorize
                .requestMatchers("/signup", "/verify-email", "/signin", "/signout").permitAll()
                .requestMatchers("/event-form", "/delete-event/**").hasRole("ORGANIZER")
                .requestMatchers("/book-event/**","/checkout", "/success").hasRole("PARTICIPANT")
