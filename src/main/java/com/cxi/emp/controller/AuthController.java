...
@PostMapping("/signup")
  ...
  // @PostMapping("/signin")
  // public ResponseEntity<String> signIn(@ModelAttribute UserDto userDto, Model model){
  //   try{
  //     userService.signIn(userDto.email(), userDto.password());
 ...
 private boolean isValidEmailDomain(String email){
    ...
    try {
      InetAddress.getByName(domain); // Check if domain exists
      return true;
  ...
  //   session.invalidate();
  //   System.out.println("User has signed out and session has been invalidated.");
  //   return "redirect:/";
  // }
